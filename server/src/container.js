...
import { RecordatorioRepository } from './repositories/recordatorio.repository.js';
...
export const buildContainer = (db) => {
  ...
  const recordatorioRepo   = new RecordatorioRepository(db);
  ...
  const recordatorioService = new RecordatorioService({ recordatorioRepository: recordatorioRepo });
  ...
  const controllers = {
    ...
    recordatorioController: new RecordatorioController({ recordatorioService }),
  };
